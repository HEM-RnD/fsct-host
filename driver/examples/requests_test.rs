...
async fn main() -> anyhow::Result<()> {
    ...
    for device in devices {
        ...
        fsct_device
            .set_current_text(FsctTextMetadata::CurrentTitle, Some(current_title))
            .await?;
        println!("Set current title: \"{}\"", current_title);
        fsct_device
            .set_current_text(FsctTextMetadata::CurrentAuthor, Some(current_artist))
            .await?;
        ...
        fsct_device
            .set_current_text(FsctTextMetadata::CurrentTitle, None)
            .await?;
        fsct_device
            .set_current_text(FsctTextMetadata::CurrentAuthor, None)
            .await?;
