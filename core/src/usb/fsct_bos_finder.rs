...
pub fn get_fsct_vendor_subclass_number_from_device(device: &DeviceInfo) -> Result<Option<u8>, String> {
    //TODO add check if device bcdUSB is > 0x0200, because BOS descriptor is only available in USB 2.01 and later
